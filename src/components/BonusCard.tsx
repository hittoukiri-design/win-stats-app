...
function BonusCard({ bonus }: BonusCardProps) {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 border border-slate-700/50 p-8 h-full min-h-[500px] flex flex-col hover:border-primary/60 group">
      {/* Background Image with Enhanced Overlay */}
      {bonus.promotionalImage && (
        <div className="absolute inset-0 opacity-25 group-hover:opacity-35">
          <Image
      ...
      <div className="relative z-10 flex flex-col h-full">
        {/* Icon */}
        <div className="mb-6">
          <div className="w-12 h-12 bg-gradient-to-br from-primary/30 to-primary/10 rounded-xl flex items-center justify-center border border-primary/30 group-hover:border-primary/60">
        ...
        {/* Claim Button */}
        <button className="w-full py-3 px-6 border-2 border-primary text-primary font-heading font-bold rounded-xl hover:bg-primary hover:text-white text-center text-base">
          Claim Bonus
        </button>
      </div>
    </div>
