        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {[
              ...
              { q: 'What is the minimum topup amount?', a: 'The minimum topup amount is ₹100. You can topup using UPI, Paytm, E-Wallet, or USDT.' },
              { q: 'How long do redemptions take?', a: 'Redemptions are typically processed within 1 to 24 hours, depending on the payment method chosen.' },
