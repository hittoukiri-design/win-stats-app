        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            <AnimatedElement delay={100}>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold text-white mb-6 tracking-tight" style={{textShadow: '0 0 8px rgba(41, 121, 242, 0.8), 0 0 16px rgba(41, 121, 242, 0.6), 0 0 24px rgba(41, 121, 242, 0.4)'}}>Dostwin Game</h1>
            </AnimatedElement>
