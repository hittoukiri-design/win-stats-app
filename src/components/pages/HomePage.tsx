          ...
          <AnimatedElement delay={100}>
            <div className="bg-zinc-900/50 border border-zinc-800/50 rounded-3xl p-6 md:p-10 backdrop-blur-sm">
              ...
              <div className="space-y-4 text-zinc-400">
                ...
                <p><a href="https://www.dostwinapp.co/blog/top-mobile-friendly-betting-sites-india" className="text-primary hover:underline">Platform fully mobile friendly, fast loading, aur smooth gameplay, even slow internet pe bhi no</a></p>
