  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-zinc-300 font-paragraph selection:bg-primary/30 selection:text-white overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 from-[#0a0a0c]/5 via-[#0a0a0c]/10 to-[#0a0a0c]/15 mix-blend-multiply opacity-100 bg-[#0a0a0c]" />
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
            ...
            <AnimatedElement delay={200} className="flex-1 flex justify-center gap-4">
              <div className="relative w-48 h-[380px] bg-zinc-900 rounded-[2rem] border-4 border-zinc-800 overflow-hidden shadow-xl hidden md:block hidden">
