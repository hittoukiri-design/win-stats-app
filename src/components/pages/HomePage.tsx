  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-zinc-300 font-paragraph selection:bg-primary/30 selection:text-white overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://static.wixstatic.com/media/dc7695_780098e6b1d34901b9718d15a77944ee~mv2.png')] bg-cover bg-center bg-no-repeat opacity-100" style={{ backgroundSize: 'cover', backgroundPosition: 'center' }} />
