          ...
          <div className="min-h-[300px]">
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {/* Additional Container - Refer a Friend Bonus */}
                {(() => {
                  const referAFriendBonus = bonuses.find(b => b.bonusTitle?.toLowerCase().includes('refer'));
                  return referAFriendBonus ? (
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                          ...
                          <div className="mb-6">
                            <h3 className="text-3xl font-heading font-bold text-white mb-2 leading-tight">
                              {referAFriendBonus.bonusTitle || 'Refer a Friend'}
                            </h3>
                            <p className="text-base text-gray-300 font-paragraph leading-relaxed">
                              {referAFriendBonus.subtitle || 'Share and earn rewards'}
                            </p>
                          </div>

                          {/* Description */}
                          <div className="space-y-3 mb-8 flex-grow">
                            {referAFriendBonus.rewardDetails && (
                              <div className="text-sm text-gray-400 font-paragraph leading-relaxed">
                                {referAFriendBonus.rewardDetails}
                              </div>
                            )}
                            {referAFriendBonus.eligibilityCriteria && (
