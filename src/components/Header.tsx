...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-amber-900/40 via-orange-900/35 to-amber-800/40 backdrop-blur-md border-b border-amber-700/30 shadow-lg">
